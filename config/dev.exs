...
config :metadata_app, MetadataAppWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "qiXrS24XQaYpKlAneTLJjUAPM0/OEj0CwiZoeQT3Jc5WbSSXSRItgZAjPMu1C6Rz",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:metadata_app, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:metadata_app, ~w(--watch)]}
  ]
...
config :metadata_app, MetadataAppWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/metadata_app_web/(?:controllers|live|components|router)/?.*\.(ex|heex)$"
    ]
  ]
