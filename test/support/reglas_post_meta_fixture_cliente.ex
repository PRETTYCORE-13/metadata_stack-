defmodule MetadataApp.MetaBusinessProcess.Reglas.MetaFixtureCliente.Post do
  ...
  # regla post puede llamar Integraciones.ejecutar/2 de forma síncrona,
  ...
  # MetadataApp.MetaStateEngine.ReglaPost).
  ...
  def ejecutar(accion, registro, _contexto, _repo) do
    case accion do
      "activar_con_integracion" ->
        case MetadataApp.Integraciones.ejecutar("validar_externo", registro, timeout: 5_000) do
