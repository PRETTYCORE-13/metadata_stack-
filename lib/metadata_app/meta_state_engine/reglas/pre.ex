defmodule MetadataApp.MetaStateEngine.Reglas.Pre do
  @moduledoc """
  ...
  `BusinessProcessBuilder.CatalogoGenerador.impacto/1` en el resto del proyecto.
  """
  ...
  def evaluar("sin_relacionados", registro, _contexto, params) do
    ...
    MetadataApp.BusinessProcessBuilder.MetaSchemaContext.modulo_por_nombre(entidad)
