    ...
    contenido =
      Jason.encode!(
        %{
          ...
          mostrar_creado_por_en_tabla: header.mostrar_creado_por_en_tabla,
          orden_columnas_tabla: header.orden_columnas_tabla,
          orden_resultados: header.orden_resultados,
