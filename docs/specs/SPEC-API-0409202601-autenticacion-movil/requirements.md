...
**Actores:**
- **Usuario final** — se loguea desde la app Flutter con email+contraseña, permanece logueado entre aperturas de la app sin volver a escribir la contraseña cada vez.
...
Ninguna pendiente — las 4 que estaban acá se resolvieron y ya están
...
incluye), límite de intentos fallidos (R10), y `confirmed_at` sin
chequear, igual que la web (R1).
