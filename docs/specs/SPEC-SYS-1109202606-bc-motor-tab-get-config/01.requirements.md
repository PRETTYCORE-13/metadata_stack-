...
**Documento:** Requirements · **Fase:** ✅ aprobada (2026-09-11) — documentación retroactiva + 1 fix real (R14, código muerto eliminado, ver `03.tasks.md` Grupo D) + 1 sección completa ELIMINADA (2026-09-12, §5, ver R18 y `03.tasks.md` Grupo E).
