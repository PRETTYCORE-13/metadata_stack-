...
text-purple-600` — sin `focus:ring-purple-500`, que ese otro sí trae
porque es interactivo y este es de solo lectura) — patrón ya
confirmado visible en la misma página.
