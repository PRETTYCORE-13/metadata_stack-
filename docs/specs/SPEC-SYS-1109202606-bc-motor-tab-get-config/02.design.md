...
en la misma página. Color azul (`text-blue-600`, no `text-purple-600`)
a pedido explícito del usuario, tras confirmar visualmente que el
checkbox ya se veía — distinto del morado del checkbox de selección,
para no confundir visualmente "este es un dato del registro" con "este
registro está seleccionado".
