...
**Documento:** Design · **Fase:** ✅ aprobada (2026-09-11) — con 1 fix real (§6, R14): código muerto eliminado a pedido explícito del usuario, ver `03.tasks.md`. **2026-09-12**: §5 completa ("Filtros por default") ELIMINADA del código a pedido explícito del usuario — ver §5 reescrita y `03.tasks.md` Grupo E.
...
Igual que `01.requirements.md` §6.
