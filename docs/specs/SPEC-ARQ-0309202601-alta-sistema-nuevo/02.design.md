...
- **Propagación entre canales** — `mix motor.propagar_extension <ambiente>
  ...
  SPEC-ARQ-1809202603 R1 — mismo comportamiento exacto) —
...
- **Propagar a un sistema de cliente** — `mix motor.propagar_extension_a_sistema
  ...
  SPEC-ARQ-1809202603 R2 — mismo comportamiento exacto) —
...
- **`metadata-stack-app` se recrea desde cero como `metadata-unstable`,
  ...
  (renombrados, SPEC-ARQ-1809202603 R1/R2) siguen sin poder
