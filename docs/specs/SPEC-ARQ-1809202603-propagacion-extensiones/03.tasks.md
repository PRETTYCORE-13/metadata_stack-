...
3. [x] Grep de `motor.promover`/`motor.actualizar` en todo el repo —
   actualizadas las menciones reales: `SPEC-ARQ-0309202601/design.md`
   ...
   `SPEC-ARQ-0309202601/requirements.md` R10 no citaba el nombre
   literal — sin cambios ahí. `SPEC-ARQ-0309202601/tasks.md` (histórico,
