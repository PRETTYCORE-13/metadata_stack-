...
| Guardar un secreto que solo hay que poder VERIFICAR, nunca releer | `SesionMovil` (hash del refresh token, `SPEC-APP-0409202601`) — la API key sigue el mismo patrón, NO el de `MetadataApp.Encriptado` (ver §1, cambiado tras R25) |
